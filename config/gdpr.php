...
return [
    ...
    */
    'cookie_consent' => [
        'enabled' => true,
        'message' => 'Este sitio web utiliza cookies para mejorar su experiencia. Al continuar navegando, aceptas su uso.',
        // Otras configuraciones como 'dismiss', 'link', 'href' pueden dejarse con sus valores predeterminados o ser omitidas.
    ],
