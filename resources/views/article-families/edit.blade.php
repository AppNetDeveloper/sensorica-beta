        ...
        <div class="col-lg-8 mx-auto">
            <div class="card border-0 shadow">
                <div class="card-header border-0">
                    <h5 class="card-title text-white mb-0">@lang('Edit Article Family'): {{ $articleFamily->name }}</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('article-families.update', $articleFamily) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror"
                                      id="description" name="description" rows="4">{{ old('description', $articleFamily->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex justify-content-between mt-4 gap-2">
                            ...
                            <div class="d-flex gap-2">
                                <a href="{{ route('article-families.show', $articleFamily) }}" class="btn-cancel-modal">
