    ...
    <form action="{{ route('smartsensors.update', $sensor->id) }}" method="POST">
        ...
        <div class="form-group">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="auto_optimal_time_enabled" name="auto_optimal_time_enabled" value="1" {{ $sensor->auto_optimal_time_enabled ? 'checked' : '' }}>
        ...
        <div class="form-group">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="auto_update_sensor_optimal_time" name="auto_update_sensor_optimal_time" value="1" {{ $sensor->auto_update_sensor_optimal_time ? 'checked' : '' }}>
