...
@section('title', 'Editar Transformación de Sensor')
    ...
    <div class="col-lg-12">
        <div class="card border-0 shadow">
            <div class="card-header border-0">
                <h4 class="card-title mb-0">{{ __('Editar Transformación de Sensor') }}</h4>
            </div>
            <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('sensor-transformations.update', $sensorTransformation->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $sensorTransformation->name) }}" placeholder="Nombre de la transformación">
                        </div>

                        <!-- Descripción -->
                        <div class="form-group">
                            <label for="description">{{ __('Descripción') }}</label>
                            <textarea class="form-control" id="description" name="description" rows="3" placeholder="Descripción de la transformación">{{ old('description', $sensorTransformation->description) }}</textarea>
                        </div>

                        <!-- Valor Mínimo -->
                        <div class="form-group">
                            <label for="min_value">{{ __('Valor Mínimo') }}</label>
                            <input type="number" step="0.01" class="form-control" id="min_value" name="min_value" value="{{ old('min_value', $sensorTransformation->min_value) }}" placeholder="Valor mínimo">
                        </div>

                        <!-- Valor Intermedio -->
                        <div class="form-group">
                            <label for="mid_value">{{ __('Valor Intermedio') }}</label>
                            <input type="number" step="0.01" class="form-control" id="mid_value" name="mid_value" value="{{ old('mid_value', $sensorTransformation->mid_value) }}" placeholder="Valor intermedio">
                        </div>

                        <!-- Valor Máximo -->
                        <div class="form-group">
                            <label for="max_value">{{ __('Valor Máximo') }}</label>
                            <input type="number" step="0.01" class="form-control" id="max_value" name="max_value" value="{{ old('max_value', $sensorTransformation->max_value) }}" placeholder="Valor máximo">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="below_min_value_output" name="below_min_value_output" value="{{ old('below_min_value_output', $sensorTransformation->below_min_value_output ?? '0') }}" placeholder="Valor a enviar cuando es menor o igual al mínimo">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="min_to_mid_value_output" name="min_to_mid_value_output" value="{{ old('min_to_mid_value_output', $sensorTransformation->min_to_mid_value_output ?? '1') }}" placeholder="Valor a enviar cuando está entre mínimo y medio">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="mid_to_max_value_output" name="mid_to_max_value_output" value="{{ old('mid_to_max_value_output', $sensorTransformation->mid_to_max_value_output ?? '2') }}" placeholder="Valor a enviar cuando está entre medio y máximo">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="above_max_value_output" name="above_max_value_output" value="{{ old('above_max_value_output', $sensorTransformation->above_max_value_output ?? '3') }}" placeholder="Valor a enviar cuando es mayor que el máximo">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="input_topic" name="input_topic" value="{{ old('input_topic', $sensorTransformation->input_topic) }}" placeholder="Ejemplo: sensor/temperatura/raw" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="output_topic" name="output_topic" value="{{ old('output_topic', $sensorTransformation->output_topic) }}" placeholder="Ejemplo: sensor/temperatura/transformed" required>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="active" name="active" value="1" {{ old('active', $sensorTransformation->active) ? 'checked' : '' }}>
