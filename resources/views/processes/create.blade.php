        ...
        <div class="col-lg-8 mx-auto">
            <div class="card border-0 shadow">
                <div class="card-header border-0">
                    <h5 class="card-title text-white mb-0">@lang('New Process')</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-4">
                                    ...
                                    <small class="form-text text-muted">@lang('Position where this process will be displayed in the Kanban')</small>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div id="color-preview" class="mt-1" style="width: 100px; height: 30px; border-radius: 8px; background: {{ old('color', '#6c757d') }};"></div>
                                        </div>
                                    </div>
                                    @error('color')
                                        <div class="invalid-feedback">{{ $message }}</div>
