...
@section('title', __('Nuevo centro de coste') . ' - ' . $customer->name)
@section('page-title', __('Nuevo centro de coste'))
...
<div class="mb-4">
  <ul class="breadcrumb">
    ...
    <li class="breadcrumb-item active">{{ __('Nuevo centro de coste') }}</li>
  </ul>
</div>
@endsection
...
<div class="card">
  <div class="card-header">
    <h5 class="mb-0">{{ __('Crear centro de coste') }}</h5>
  </div>
  <div class="card-body">
    <form action="{{ route('customers.asset-cost-centers.store', $customer) }}" method="POST">
      @csrf
      <div class="row g-3">
        <div class="col-md-4">
