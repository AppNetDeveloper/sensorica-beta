...
@section('title', __('Edit Original Order'))
            ...
            <div class="card border-0 shadow" style="width: 100%;">
                <div class="card-header bg-primary text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3 class="card-title mb-0">{{ __('Edit Original Order') }} - {{ $originalOrder->order_id }}</h3>
                    </div>
                </div>
                @include('customers.original-orders.form', [
                    'originalOrder' => $originalOrder,
                    'selectedProcesses' => old('processes', $selectedProcesses ?? []),
                    'customer' => $customer,
                    'processes' => $processes ?? []
                ])
            </div>
