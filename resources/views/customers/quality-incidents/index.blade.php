...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            const defaultPromptQI = {!! json_encode(__('Actúa como analista de calidad. Resume las incidencias listadas agrupándolas por línea y operador, destaca causas raíz repetidas, calcula totales por estado y propone acciones correctivas priorizadas.')) !!};
