...
class FakeOrderTimeController extends Controller
{
    /**
     * Endpoint de prueba para obtener el tiempo efectivo de producción
     * para un orderId fijo.
     *
     * Ejemplo de uso:
     * GET /api/test-order-time
     *
     * @return \Illuminate\Http\JsonResponse
     */
    public function index()
    {
        // Definir el orderId de prueba
        #$orderId = "231823-51/963-003.01";
        #$orderId = "231803-51/933-002.01";
        #$orderId= "231815-51/945-001.01";
